...
# BallasMusicVaves tarafından düzenlendi. 

@Client.on_message(command(["start", f"start@{BOT_USERNAME}"]))
async def start(_, message: Message):
                await message.reply_photo(
                "https://i.ibb.co/Fx7J4MH/Logopit-1663987970479.png",
                caption=(f"""**Merhaba {message.from_user.mention} 🎵\nBen {bot}!\nSesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz.\n\nDüzen Tasarım [Ballas music 🎙️](https://t.me/Ballasticaret).**"""),
         reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/Ballasplayerbot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/Ballasplayerasistan"
                    ),
                    InlineKeyboardButton(
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/Ballasticaret"
                    )
                ]
